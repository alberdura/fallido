...
function vw_tour_lite_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('vw_tour_lite_navigation_menu_font_size',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_tour_lite_navigation_menu_font_size',array(
		'label'	=> __('Menus Font Size','vw-tour-lite'),
		'description'	=> __('Enter a value in pixels. Example:20px','vw-tour-lite'),
		'input_attrs' => array(
            'placeholder' => __( '10px', 'vw-tour-lite' ),
        ),
	...
	$wp_customize->add_setting('vw_tour_lite_navigation_menu_font_weight',array(
        'default' => 'Default',
        'transport' => 'refresh',
        'sanitize_callback' => 'vw_tour_lite_sanitize_choices'
	));
	$wp_customize->add_control('vw_tour_lite_navigation_menu_font_weight',array(
        'type' => 'select',
        'label' => __('Menus Font Weight','vw-tour-lite'),
        'section' => 'vw_tour_lite_headercont_section',
        'choices' => array(
        	'Default' => __('Default','vw-tour-lite'),
            'Normal' => __('Normal','vw-tour-lite')
        ),
	) );
    ...
    $wp_customize->add_setting('vw_tour_lite_slider_content_padding_top_bottom',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_tour_lite_slider_content_padding_top_bottom',array(
		'label'	=> __('Slider Content Padding Top Bottom','vw-tour-lite'),
		'description'	=> __('Enter a value in %. Example:20%','vw-tour-lite'),
		'input_attrs' => array(
            'placeholder' => __( '50%', 'vw-tour-lite' ),
        ),
		'section'=> 'vw_tour_lite_slidersettings',
		'type'=> 'text'
	));

	$wp_customize->add_setting('vw_tour_lite_slider_content_padding_left_right',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_tour_lite_slider_content_padding_left_right',array(
		'label'	=> __('Slider Content Padding Left Right','vw-tour-lite'),
		'description'	=> __('Enter a value in %. Example:20%','vw-tour-lite'),
		'input_attrs' => array(
            'placeholder' => __( '50%', 'vw-tour-lite' ),
        ),
    ...
    $wp_customize->add_setting( 'vw_tour_lite_featured_image_hide_show',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_tour_lite_switch_sanitization'
	));
    $wp_customize->add_control( new VW_Tour_Lite_Toggle_Switch_Custom_Control( $wp_customize, 'vw_tour_lite_featured_image_hide_show', array(
		'label' => esc_html__( 'Featured Image','vw-tour-lite' ),
		'section' => 'vw_tour_lite_post_settings'
    )));

    $wp_customize->add_setting( 'vw_tour_lite_featured_image_border_radius', array(
		'default'              => '0',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_tour_lite_sanitize_number_range'
	) );
	$wp_customize->add_control( 'vw_tour_lite_featured_image_border_radius', array(
		'label'       => esc_html__( 'Featured Image Border Radius','vw-tour-lite' ),
		'section'     => 'vw_tour_lite_post_settings',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_setting( 'vw_tour_lite_featured_image_box_shadow', array(
		'default'              => '0',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_tour_lite_sanitize_number_range'
	) );
	$wp_customize->add_control( 'vw_tour_lite_featured_image_box_shadow', array(
		'label'       => esc_html__( 'Featured Image Box Shadow','vw-tour-lite' ),
		'section'     => 'vw_tour_lite_post_settings',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_setting('vw_tour_lite_meta_field_separator',array(
		'default'=> '|',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_tour_lite_meta_field_separator',array(
		'label'	=> __('Add Meta Separator','vw-tour-lite'),
		'description' => __('Add the seperator for meta box. Example: "|", "/", etc.','vw-tour-lite'),
		'section'=> 'vw_tour_lite_post_settings',
		'type'=> 'text'
	));
	...
	$wp_customize->add_section('vw_tour_lite_no_results_page',array(
		'title'	=> __('No Results Page Settings','vw-tour-lite'),
		'panel' => 'vw_tour_lite_panel_id',
	));	

	$wp_customize->add_setting('vw_tour_lite_no_results_page_title',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));

	$wp_customize->add_control('vw_tour_lite_no_results_page_title',array(
		'label'	=> __('Add Title','vw-tour-lite'),
		'input_attrs' => array(
            'placeholder' => __( 'Nothing Found', 'vw-tour-lite' ),
        ),
		'section'=> 'vw_tour_lite_no_results_page',
		'type'=> 'text'
	));

	$wp_customize->add_setting('vw_tour_lite_no_results_page_content',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));

	$wp_customize->add_control('vw_tour_lite_no_results_page_content',array(
		'label'	=> __('Add Text','vw-tour-lite'),
		'input_attrs' => array(
            'placeholder' => __( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'vw-tour-lite' ),
        ),
		'section'=> 'vw_tour_lite_no_results_page',
		'type'=> 'text'
	));
	...
	$wp_customize->add_setting('vw_tour_lite_footer_background_color', array(
		'default'           => '#1c3248',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'vw_tour_lite_footer_background_color', array(
		'label'    => __('Footer Background Color', 'vw-tour-lite'),
	...
	$wp_customize->add_setting('vw_tour_lite_copyright_font_size',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_tour_lite_copyright_font_size',array(
		'label'	=> __('Copyright Font Size','vw-tour-lite'),
		'description'	=> __('Enter a value in pixels. Example:20px','vw-tour-lite'),
		'input_attrs' => array(
            'placeholder' => __( '10px', 'vw-tour-lite' ),
        ),
	...
	//Selective Refresh
	$wp_customize->selective_refresh->add_partial( 'vw_tour_lite_woocommerce_shop_page_sidebar', array( 'selector' => '.post-type-archive-product .sidebar', 
		'render_callback' => 'vw_tour_lite_customize_partial_vw_tour_lite_woocommerce_shop_page_sidebar', ) );
    ...
    //Selective Refresh
	$wp_customize->selective_refresh->add_partial( 'vw_tour_lite_woocommerce_single_product_page_sidebar', array( 'selector' => '.single-product .sidebar', 
		'render_callback' => 'vw_tour_lite_customize_partial_vw_tour_lite_woocommerce_single_product_page_sidebar', ) );
	...
	$wp_customize->add_setting( 'vw_tour_lite_products_button_border_radius', array(
		'default'              => '0',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_tour_lite_sanitize_number_range'
	) );
	$wp_customize->add_control( 'vw_tour_lite_products_button_border_radius', array(
		'label'       => esc_html__( 'Products Button Border Radius','vw-tour-lite' ),
		'section'     => 'vw_tour_lite_woocommerce_section',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
	...
	//Products Sale Badge
	$wp_customize->add_setting('vw_tour_lite_woocommerce_sale_position',array(
        'default' => 'right',
        'sanitize_callback' => 'vw_tour_lite_sanitize_choices'
	));
	$wp_customize->add_control('vw_tour_lite_woocommerce_sale_position',array(
        'type' => 'select',
        'label' => __('Sale Badge Position','vw-tour-lite'),
        'section' => 'vw_tour_lite_woocommerce_section',
        'choices' => array(
            'left' => __('Left','vw-tour-lite'),
            'right' => __('Right','vw-tour-lite'),
        ),
	) );

	$wp_customize->add_setting('vw_tour_lite_woocommerce_sale_font_size',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_tour_lite_woocommerce_sale_font_size',array(
		'label'	=> __('Sale Font Size','vw-tour-lite'),
		'description'	=> __('Enter a value in pixels. Example:20px','vw-tour-lite'),
		'input_attrs' => array(
            'placeholder' => __( '10px', 'vw-tour-lite' ),
        ),
	...
	$wp_customize->add_setting( 'vw_tour_lite_woocommerce_sale_border_radius', array(
		'default'              => '100',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_tour_lite_sanitize_number_range'
	) );
	$wp_customize->add_control( 'vw_tour_lite_woocommerce_sale_border_radius', array(
		'label'       => esc_html__( 'Sale Border Radius','vw-tour-lite' ),
		'section'     => 'vw_tour_lite_woocommerce_section',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
